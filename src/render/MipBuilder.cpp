...
MippedImageProxy::MippedImageProxy(lz::RenderGraph *render_graph, vk::Format format, glm::uvec2 base_size_, vk::ImageUsageFlags usage_flags)
{
	base_size           = glm::vec2(lz::math::previous_power_of_two(base_size_.x), lz::math::previous_power_of_two(base_size_.y));
