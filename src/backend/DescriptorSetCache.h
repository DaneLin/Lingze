...
namespace lz
{
	struct DescriptorSetBindings
	{
		...
		DescriptorSetBindings& set_uniform_buffer_bindings(
			const std::vector<UniformBufferBinding>& uniform_buffer_bindings);
		DescriptorSetBindings& set_image_sampler_bindings(
			const std::vector<ImageSamplerBinding>& image_sampler_bindings);
		DescriptorSetBindings& set_storage_buffer_bindings(
			const std::vector<StorageBufferBinding>& storage_buffer_bindings);
		DescriptorSetBindings& set_storage_image_bindings(
	...
	public:
		...
		vk::DescriptorSet get_descriptor_set(const lz::DescriptorSetLayoutKey& set_layout_key,
