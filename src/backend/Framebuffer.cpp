...
Framebuffer::Framebuffer(const vk::Device logical_device, const std::vector<const ImageView *> &image_views, const vk::Extent2D size, const vk::RenderPass render_pass)
{
