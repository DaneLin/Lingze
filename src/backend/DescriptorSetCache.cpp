...
namespace lz
{
	...
	DescriptorSetCache::DescriptorSetCache(const vk::Device logical_device) : logical_device_(logical_device)
	{
	...
	{
		return
			std::tie(layout, bindings.uniform_buffer_bindings, bindings.storage_buffer_bindings,
