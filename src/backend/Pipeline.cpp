...
namespace lz
{
	...
	GraphicsPipeline::GraphicsPipeline(vk::Device logical_device, vk::ShaderModule vertex_shader,
	                                   vk::ShaderModule fragment_shader, const lz::VertexDeclaration& vertex_decl,
	                                   vk::PipelineLayout pipeline_layout,
	                                   DepthSettings depth_settings,
	                                   const std::vector<BlendSettings>& attachment_blend_settings,
	                                   vk::PrimitiveTopology primitive_topology, vk::RenderPass render_pass)
	{
		...
		vk::PipelineShaderStageCreateInfo shader_stage_infos[] = {vertex_stage_create_info, fragment_stage_create_info};
