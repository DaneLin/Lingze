...
vk::Format VertexDeclaration::convert_attrib_type_to_format(AttribTypes attrib_type)
{
	switch (attrib_type)
	{
		case AttribTypes::eFloatType:
			return vk::Format::eR32Sfloat;
			break;
		case AttribTypes::eVec2:
			return vk::Format::eR32G32Sfloat;
			break;
		case AttribTypes::eVec3:
			return vk::Format::eR32G32B32Sfloat;
			break;
		case AttribTypes::eVec4:
			return vk::Format::eR32G32B32A32Sfloat;
			break;
		case AttribTypes::eU8Vec3:
			return vk::Format::eR8G8B8Unorm;
			break;
		case AttribTypes::eU8Vec4:
			return vk::Format::eR8G8B8A8Unorm;
			break;
		case AttribTypes::eI8Vec4:
			return vk::Format::eR8G8B8A8Snorm;
			break;
		case AttribTypes::eColor32:
			return vk::Format::eR8G8B8A8Unorm;
			break;
	}
