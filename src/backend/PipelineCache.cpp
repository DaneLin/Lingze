...
{
	return std::tie(set_layouts) < std::tie(other.set_layouts);
}
...
{
	return std::tie(shader_stages, vertex_decl, pipeline_layout, render_pass, depth_settings,
...
{
	return std::tie(compute_shader, pipeline_layout) <
